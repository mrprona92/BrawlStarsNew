package com.mrprona.brawlassistant.base.menu.adapter;
...
import com.mrprona.brawlassistant.base.menu.entity.MenuItem;
...
public class DHMenuAdapter extends RecyclerView.Adapter<DHMenuAdapter.ViewHolder> {
    ...
    private void initializeMenuItems() {
        mArrayMenuItems = new MenuItem[]{
                ...
                new MenuItem(R.string.menu_report_a_bug, R.drawable.ic_menu_report_a_bug, 1, false),
