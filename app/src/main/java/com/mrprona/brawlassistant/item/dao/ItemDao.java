package com.mrprona.brawlassistant.item.dao;
...
public class ItemDao extends GeneralDaoImpl<Item> {
    ...
    public Item cursorToEntity(Cursor cursor, int index) {
        ...
        i++;
        entity.setDotaName(cursor.getString(i));
        i++;
    ...
    protected ContentValues entityToContentValues(Item entity) {
        ...
        if (!TextUtils.isEmpty(entity.getDotaName())) {
            values.put(COLUMN_DNAME, entity.getDotaName());
        } else {
