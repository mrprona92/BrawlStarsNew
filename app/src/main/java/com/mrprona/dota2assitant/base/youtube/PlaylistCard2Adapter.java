package com.mrprona.dota2assitant.base.youtube;
...
import com.mrprona.dota2assitant.base.youtube.model.PlaylistVideos;
 ...
 */
public class PlaylistCard2Adapter extends RecyclerView.Adapter<PlaylistCard2Adapter.ViewHolder> {
    ...
    public PlaylistCard2Adapter(PlaylistVideos playlistVideos, YouTubeRecyclerViewFragment.LastItemReachedListener lastItemReachedListener) {
    ...
    @Override
    public PlaylistCard2Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.mViewCountText.setText(sFormatter.format(videoStatistics.getViewCount()) + " Views");
        //Log.d("BINH", "onBindViewHolder() called with: holder = [" + holder + "], position = [" + videoStatistics.getLikeCount() + "]");
        ...
        if (mListener != null) {
            ...
            final String nextPageToken = getNextPageToken();
            if (!isEmpty(nextPageToken) && position == mPlaylistVideos.size() - 1) {
                holder.itemView.post(new Runnable() {
                    @Override
                    public void run() {
                        mListener.onLastItem(position, mPlaylistVideos.getNextPageToken());
                    }
                });
            }
        }
