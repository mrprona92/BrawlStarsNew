...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    private final ArrayList<Video> mPlaylistVideos;
    ...
    public PlaylistCardAdapter(ArrayList<Video> playlistVideos, YouTubeRecyclerViewFragment.LastItemReachedListener lastItemReachedListener) {
